...
def estilos_globales():
    ...
    <div class="footer-credits">
        <div style="font-weight: bold; color: #002F6C;">Hecho por: Chaluisa Sebastian, Domínguez Karla, Simbaña Erick, Puetate Juan, Tipán María.</div>
...
def interfaz_chat():
    ...
    with col_logo:
        if os.path.exists(LOGO_URL):
            # Margen superior para que el logo aparezca completo
    ...
    with col_titulo:
        st.markdown("""
            <div style="padding-top: 30px;">
                ...
                <p style='margin-top: 0px; color: gray; font-size: 16px;'>Ing. Glaux Shopos - Tu Tutor Virtual de la FICA</p>
            </div>
        ...
        with contenedor_chat:
            with st.chat_message("assistant", avatar=avatar_bot):
                ...
                try:
                    ...
                    response = model.generate_content(f"Eres el Ing. Glaux Shopos. Contexto: {contexto}. Pregunta: {st.session_state.messages[-1]['content']}")
